...
public class HeaderAnimatedScrollView extends NestedScrollView {
    ...
    public HeaderAnimatedScrollView(Context context) {
        super(context);
        this.context = context;
    }

    public HeaderAnimatedScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        listener.onScrollChanged(-1, getScrollY() * 0.6f);
    }
}
